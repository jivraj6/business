...
class _ProductsPageState extends State<ProductsPage> {
              ...
              builder: (context, constraints) {
                ...
                return Column(
                  children: [
                    ...
                    Expanded(
                      child: _buildGrid(context, provider, constraints),
                    ),
                  ],
                );
              },
  ...
  // ---------- HEADER ----------------
  Widget _buildHeader(BuildContext context, ProductProvider provider, bool isDesktop) {
    return Padding(
  ...
  // ---------- GRID ----------------
  Widget _buildGrid(BuildContext context, ProductProvider provider, BoxConstraints c) {
    int crossAxisCount = 2;
    if (c.maxWidth > 1200) crossAxisCount = 5;
    else if (c.maxWidth > 900) crossAxisCount = 4;
  ...
  void _showEditForm(Product p) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ProductFormPage(product: p),
      ),
    );
  }
